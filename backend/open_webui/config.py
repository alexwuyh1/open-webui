...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        {
            'title': ['帮我学习', '大学入学考试词汇'],
            'content': '帮我学习词汇：请写一个填空句子，我会尝试选择正确的选项。',
        },
        {
            'title': ['给我一些主意', '如何处理孩子的艺术作品'],
            'content': '有什么创意方法可以处理孩子的艺术作品？我不想扔掉它们，但东西实在太多了。',
        },
        {
            'title': ['告诉我一个趣闻', '关于罗马帝国'],
            'content': '告诉我一个关于罗马帝国的随机趣闻',
        },
        {
            'title': ['显示代码片段', '网站的固定页眉'],
            'content': '请显示一个使用 CSS 和 JavaScript 实现的网站固定页眉（sticky header）的代码片段。',
        },
        {
            'title': [
                '解释期权交易',
            ...
            'content': '如果我熟悉股票买卖，请用简单的术语解释什么是期权交易。',
        },
        {
            'title': ['克服拖延症', '给我一些建议'],
            'content': '你能先询问我最常在什么时候拖延，然后给我一些克服拖延症的建议吗？',
        },
    ]
